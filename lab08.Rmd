...
ggplot(mpg, aes(displ,hwy)) +
  geom_point()+
  geom_point (aes(y=cty),color="red") +
  labs(y="Miles per Gallon", x="Size of Engine", title="Size of Engine and Fuel Efficiency ")
...
ggplot(primary, aes(lon, lat))+
  geom_point(aes(color=prop_hillary), position= "jitter") +
  scale_color_viridis()
...
Yes, there is a lack of small proportion of support for Hillary in the black belt.
