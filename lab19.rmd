...
** The burrito locations seem to have a higher Yelp rating than locations in general**:
...
**Because it only considers burrito restaurants and not all types of restaurants **:
...
**It means that the difference between Yelp reviews for burritos that inlcude chips might be better than those that dont include chips.**:
...
**The difference in Yelp reviews for burritos with chips is not statistically significant. **:
...
**It will have a low overall score**:
