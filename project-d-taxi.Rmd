...
On the following graph, the previously mentioned trend is visible. When the total fare is under 20 dollars, the percentage tip is primarily  20 to 25 percent. Moreover, when the entire fare is between 20 to 40 dollars, the most common tip is between 15 to 20 percent. 


```{r}

ggplot(taxi_nta_summary, aes(fare_amount_mean))+
  geom_density(aes(fill= tip_bin), alpha= 0.3)+
  theme_minimal()+
