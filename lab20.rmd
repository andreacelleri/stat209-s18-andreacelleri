...
**Answer**: The price of the diamond is positively related to the weight of the diamond 
...
**Answer**: Can tell us if there is a positive or negative relationship between the variables. If the slope contains zero than there is no relationship between them. 
...
**Answer**: The slope is downward sloping
...
**Answer**: With a depth of zero, the value for a diamond can be between 4312.17 and 7215.16. The more depth the diamond has the less expensive the diamond is. 
