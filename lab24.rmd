...
**Answer**: Night burglary are more positively related to neighborhood income than day burglary rates. 
...
crimes_narcotics_ca$narcotics_rate <- crimes_narcotics_ca$arrest_flag_sum / crimes_narcotics_ca$median_income * 1000


ggplot(crimes_narcotics_ca, aes(median_income, narcotics_rate)) +
  geom_point()+ 
  geom_text_repel(data=crimes_narcotics_ca, aes(label= area_name))
  

```


Thesis: Highest level of arrest relation to narcotic are influenced by neighborhoods with high gang presence. 

Example Humboldt Park: founding location of the Latin Kings
